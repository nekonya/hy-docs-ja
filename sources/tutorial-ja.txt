...
端的に言ってしまえば，HyとはLispの一方言です．しかし普通のLispとは違って，プログラムの構造をPythonに変換するもの…もう少し正確に言えば，Pythonの抽象構文木に変換するものです．（または，より砕けた言い方をするならば，HyとはPythonに付けるお化粧(Lisp-stick[*]_)である）

.. [*] たぶん口紅(lip-stick)のダジャレネタなんじゃないかと…
